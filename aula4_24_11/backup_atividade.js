...
(async ()=>{
    ...
    valorlucro = ((100-porcentagemlucro)/100);
    ...
    */
    ...
    if (opcao == 1)
    {
        ...
        hotsimples= hotsimples + (hotsimples * valorlucro);
    ...
    if (opcao == 2)
        {
            ...
            dogsalada= dogsalada + (dogsalada * valorlucro);
            console.log(`😀O lanche custa ${dogsalada}`);
        }  
    ...
    if (opcao == 3)
    {
        ...
        dogduploespecial= dogduploespecial + (dogduploespecial * valorlucro);
    ...
    if (opcao == 4)
    {
        ...
        dogtudo2salsichas= dogtudo2salsichas + (dogtudo2salsichas * valorlucro);
